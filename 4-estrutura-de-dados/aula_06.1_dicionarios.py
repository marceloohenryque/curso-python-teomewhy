...
# %%
# Dicionários: São pares de chave-valor, isto é, tem-se uma chave que
# corresponde a um único valor associado a ela.

# Pares chave/valor
# Adiciona primeiro a chave e depois o valor correspondente a esta chave
# As chaves podem ser tanto Strings quanto Inteiros (Float também mas não
# é recomendado!)
...
dados_fulano = {
    ...
    # Neste caso, o valor é uma lista e cada elemento é um dicionário
}
print(dados_fulano)
...
print(dados_fulano["cargos"][-1]["empresa"])
# Isto é muito utilizado em chamada de API's
